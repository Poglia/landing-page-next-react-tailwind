    ...
    overflow-x-clip flex z-20">
        <div className="container mx-auto px-4 w-auto">
            ...
            <div className="md:w-[478px] ">
                ...
                <p className="text-xl text-[#010D3E] tracking-tight mt-5 ">Somos Especialistas em ações judiciais para reverter negativas de medicamentos e tratamentos. Garantimos acesso rápido ao que você precisa.
                </p>
            ...
            <div className="mt-20 md:mt-0 md:h-[600px] md:flex-1">
                <Image src={HeroImage} alt="Hero" width={400} height={400} className="md:h-full w-auto md:max-w-none md:-left-6  "/>
            </div>
            </div>
        </div>
    </section>;
