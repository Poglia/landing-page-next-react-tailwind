...
const Card: React.FC<CardProps> = ({ title, description }) => {
    return (
        <div className="relative flex flex-row overflow-hidden bg-gray-50 py-6 ">
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="pt-5 text-base font-semibold leading-7">
                <p>
                  ...
                  >
                   <button className="btn btn-primary group-hover:bg-white group-hover:text-black cursor-pointer">Avalie meu caso</button>
                  </a>
                </p>
              </div>
            </div>
